...
public static class EventRegistrationTaskEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE EventRegistrationTaskModuleExtensionConfigurator CLASS (in the Domain.Shared project)
